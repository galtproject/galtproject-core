...
contract('Arbitration Voting Scenarios', accounts => {
  const [
    coreTeam,
    oracleManager,
    claimManager,
  ...
  it.skip('Scenario #3. 3 space owners / 3 galt owners / 3 oracles', async function() {
  ...
  it('Scenario #2. Three space owners voting, no oracles', async function() {
    ...
    this.candidateTopY.recalculate(candidateA, { from: unauthorized });
