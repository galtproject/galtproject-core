...
import "../../multisig/proposals/CreateGlobalProposalProposalManager.sol";
import "../../multisig/proposals/interfaces/IProposalManager.sol";


contract ArbitrationCreateGlobalProposalProposalManagerFactory is Ownable {
  function build(
  ...
  {
    proposalManager = new CreateGlobalProposalProposalManager(_config);
