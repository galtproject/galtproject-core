...
import "../../multisig/proposals/RevokeArbitratorsProposalManager.sol";
import "../../multisig/proposals/interfaces/IProposalManager.sol";


contract ArbitrationRevokeArbitratorsProposalFactory is Ownable {
  function build(
  ...
  {
    proposalManager = new RevokeArbitratorsProposalManager(_config);
