...
import "../../multisig/proposals/ModifyMinimalArbitratorStakeProposalManager.sol";
import "../../multisig/proposals/interfaces/IProposalManager.sol";


contract ArbitrationModifyArbitratorStakeProposalFactory is Ownable {
  function build(
  ...
  {
    proposalManager = new ModifyMinimalArbitratorStakeProposalManager(_config);
